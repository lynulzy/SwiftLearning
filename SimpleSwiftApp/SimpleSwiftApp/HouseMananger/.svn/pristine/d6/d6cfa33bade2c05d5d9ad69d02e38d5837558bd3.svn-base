...
@interface FinishListViewController ()
<
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"已结佣金";
...
- (void)loadCommissionListData {
    ...
    [_commissionDC mrFinishCommission:params];
}
...
- (void)onGetFinishCommissionReceiveData:(NSDictionary *)receiveDict withReqTag:(NSInteger)tag {
    ...
    self.topLab.text = [NSString stringWithFormat:@"已结算佣金 共 %@ 元", receiveDict[@"content"][@"report_commission"]];
